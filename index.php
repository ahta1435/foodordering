...
<div id="main" style="width:screen.width;height:900px;margin:0px;">
	...
	{
	?>       
			<li><a href="filter2.php?action=change&category=<?php echo $bw->categoryname;?>" ><input  type="button" class="btn btn-outline-primary btn-block" value="<?php echo $bw->categoryname?>" onclick='function($);'></a></li>
	<?php }?>
      </ul>
    </div>
   ...
   <div><button type="submit" name="add_to_cart" class="btn btn-warning my-3">ADD TO CART<i class="fas fa-shopping cart"></i></button></div>
	...
	if($_GET["action"]=="change")
     ...
     ?>	
	<div id="cont" style="width:80%;height:100%;float:left;display:none;">	
	<?php
